    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                <Button class="greybtn"> ADMIN</Button>
                <Button class="greybtn" onclick="openpart('addbook')" >ADD BOOK</Button>
                <Button class="greybtn" onclick="openpart('bookreport')" > BOOK REPORT</Button>
                <Button class="greybtn" onclick="openpart('bookrequestapprove')"> BOOK REQUESTS</Button>
                <Button class="greybtn" onclick="openpart('addperson')"> ADD STUDENT</Button>
                <Button class="greybtn" onclick="openpart('studentrecord')"> STUDENT REPORT</Button>
                <Button class="greybtn"  onclick="openpart('issuebook')"> ISSUE BOOK</Button>
                <Button class="greybtn" onclick="openpart('issuebookreport')"> ISSUE REPORT</Button>
                <a href="index.php"><Button class="greybtn" > LOGOUT</Button></a>
            </div>

            <div class="rightinnerdiv">   
            <div id="bookrequestapprove" class="innerright portion" style="display:none">
            <Button class="greybtn" >BOOK REQUEST APPROVE</Button>
            ...
            <Button class="greybtn" >ADD NEW BOOK</Button>
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="MSC.CS"/>MSC.CS<div style="margin-left:80px"><input type="radio" name="branch" value="BSC.CS"/>BSC.CS<input type="radio" name="branch" value="BCA"/>BCA</div>
            </div>   
            ...
            <Button class="greybtn" >ADD Person</Button>
            ...
            <Button class="greybtn" >Student RECORD</Button>
            ...
            <Button class="greybtn" >Issue Book Record</Button>
...
issue book -->
            ...
            <Button class="greybtn" >ISSUE BOOK</Button>
...
<br>
            ...
            <Button class="greybtn" >BOOK DETAIL</Button>
</br>
<?php
            $u=new data;
            $u->setconnection();
...
?>
            ...
            <Button class="greybtn" >BOOK RECORD</Button>
            <?php
            $u=new data;
            $u->setconnection();
            $u->getbook();
