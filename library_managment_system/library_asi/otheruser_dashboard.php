    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <Button class="greybtn" >Welcome</Button>
                <Button class="greybtn" onclick="openpart('myaccount')"> My Account</Button>
                <Button class="greybtn" onclick="openpart('requestbook')"> Request Book</Button>
                <Button class="greybtn" onclick="openpart('issuereport')"> Book Report</Button>
            ...
            <Button class="greybtn" >My Account</Button>
            ...
            <Button class="greybtn" >ISSUE RECORD</Button>
            ...
            <Button class="greybtn" >Return Book</Button>
            ...
            <Button class="greybtn" >Request Book</Button>
